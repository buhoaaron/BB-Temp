...
namespace DrawDotGame
{
    public class LevelScroller : MonoBehaviour
    {
        ...
        public int packCompletePercentage = 50;
        ...
        void Start()
        {
            ...
            int highestLevelSolved = Barnabus.DataManager.DotGameLevel;
                ...
                for (int j = count; j < buttonGroup.transform.childCount * i; j++)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if(LevelManager.IsLevelUnlocked(levelData.levelNumber))
                            {
            ...
            for (int i = 1; i <= packNumber; i++)
            {
                ...
                if (startLevelPack <= Barnabus.DataManager.DotGameLevel + 1)
                {
