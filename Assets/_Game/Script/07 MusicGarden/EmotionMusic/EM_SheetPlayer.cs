...
namespace Barnabus.EmotionMusic
{
    ...
    public class EM_SheetPlayer : MonoBehaviour
    {
        ...
        private int GetMeasureCount(Song song)
        {
            ...
            return tempo switch
            {
                TempoPerBeat.Quarter => (int)Mathf.Ceil(song.audioClip.length * (song.bpm / 60f) / 4f), //�|������(�C�p�`��4��4������=4��4������)
                TempoPerBeat.Eighth => (int)Mathf.Ceil(song.audioClip.length * (song.bpm / 60f) / 2f), //�K������(�C�p�`��4��8������=2��4������)
                TempoPerBeat.Sixteenth => (int)Mathf.Ceil(song.audioClip.length * (song.bpm / 60f)), //�Q��������(�C�p�`��4��16������=1��4������)
