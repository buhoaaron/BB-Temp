...
namespace Barnabus.EmotionMusic
{
    public class EM_SheetController : MonoBehaviour
    {
        ...
        {
            //"�ɪ�*(bpm/60)"�p��X�Ӫ��O4�����Ū��ƶq
            //return (int)Mathf.Ceil(song.audioClip.length * (song.bpm / 60f) / 4f); //�|������(�C�p�`��4��4������=4��4������)
            return (int)Mathf.Ceil(song.audioClip.length * (song.bpm / 60f) / 2f); //�K������(�C�p�`��4��8������=2��4������)
            //return (int)Mathf.Ceil(song.audioClip.length * (song.bpm / 60f)); //�Q��������(�C�p�`��4��16������=1��4������)
        }
        ...
        private void OnNotePointerEnter(NoteButton note)
        {
            ...
            {
                if (tempNoteButtonLinkList.Count >= maxNoteLinkCount) return; //�̦h4��
                if (note.NoteID / 4 != tempNoteButtonLinkList[0].NoteID / 4) return; //���b�P�@�C
                if (note.MeasureID < tempNoteButtonLinkList[0].MeasureID) return; //���੹����
                if (note.MeasureID == tempNoteButtonLinkList[0].MeasureID && note.NoteID < tempNoteButtonLinkList[0].NoteID) return; //���੹����
                if ((note.MeasureID - 1) > tempNoteButtonLinkList[^1].MeasureID) return; //��Ӧh�F�A�S�s�_��
                if (note.MeasureID == tempNoteButtonLinkList[^1].MeasureID && (note.NoteID - 1) != tempNoteButtonLinkList[^1].NoteID) return; //��Ӧh�F�A�S�s�_��
                if (note.MeasureID > tempNoteButtonLinkList[^1].MeasureID && (note.NoteID + 3) != tempNoteButtonLinkList[^1].NoteID) return; //��Ӧh�F�A�S�s�_��
                ...
                if (sameSoundIndex != -1) return; //�P�@��w�g���ۦP����F
        ...
        private void AddNote(int measureID, int noteID, out int removedNoteID)
        {
            ...
            {
                if (sameSoundIndex == -1) //��beat�|�����o�Ӽ־� => �s�W
                {
            ...
            {
                if (notes[sameIdIndex].info.characterID == SelectedCharacterID) //�P�Ӯ�־��ۦP => �R��
                {
                ...
                {
                    if(sameSoundIndex != -1) //��beat��L��l���ۦP�־�
                    {
                        if (!notes[sameSoundIndex].info.isLongSound)
                        {
