namespace Barnabus.Network
{
    ...
    {
        public readonly int meandmine_id;
        ...
        public SendCreatePlayer(int meandmine_id, bool is_parent_owned, string first_name, string last_name, string grade, string country_code, string state, AvatarInfo avatar)
        {
